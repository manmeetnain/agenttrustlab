...
LangGraph, Pydantic AI and MCP are the next compatibility tier, followed by CrewAI, AutoGen, Google ADK and smolagents. An adapter is not labelled supported until it passes conformance and trace-parity fixtures in CI.
